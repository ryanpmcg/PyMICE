    ...
    b.numbered_section(
        ...
        [
            TutorialPart(
                ...
                r_code="help(boys)\n?boys",
                r_expected=R_HELP,
                python_code="print(format_help_r('boys', max_lines=32))",
                run=lambda: format_help_r("boys", max_lines=32),
                partial=True,
                partial_reason="Truncated R help excerpt (full pager is very long).",
            ),
        ],
    )
    ...
    b.numbered_section(
        ...
        [
            TutorialPart(
                ...
                python_code="print(format_help_r('mammalsleep', max_lines=28))",
                run=lambda: format_help_r("mammalsleep", max_lines=28),
                partial=True,
                partial_reason="Truncated R help excerpt (full pager is very long).",
            ),
            TutorialPart(
