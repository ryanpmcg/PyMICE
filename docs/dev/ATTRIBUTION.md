...
The `reference/` folder contains HTML and extracted R code from:

- [miceVignettes](https://www.gerkovink.com/micereference/) (Gerko Vink, Stef van Buuren)
...
- RNG behavior and reporting: [`REPRODUCIBILITY.md`](REPRODUCIBILITY.md)
- PyPI release checklist and citation: [`PUBLICATION.md`](PUBLICATION.md)
