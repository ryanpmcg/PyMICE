...
| **Vignettes** | [gerkovink.com/miceVignettes](https://www.gerkovink.com/micereference/) | Tutorial material (see `reference/`) |
| **FIMDcode** | [stefvanbuuren/fimdbook](https://github.com/stefvanbuuren/fimdbook/tree/master/R) | Book companion scripts |

## Implementation mapping

| Concept | Primary refs | `pymice` module |
|---------|--------------|-----------------|
| FCS / Gibbs sampler | JSS2011, FCS2006 | `pymice.engine` |
| Predictor matrix / setup | JSS2011 | `pymice.imputation_setup` |
| PMM / norm / logreg / polyreg | JSS2011, SMMR2007 | `pymice.methods` (35 registered) |
| Rubin pooling | RUBIN1987, JSS2011 | `pymice.pool` |
| Convergence diagnostics | FIMD2018 Ch. 5 | `pymice.diagnostics` |
| Passive imputation | JSS2011 | `pymice.passive_formula` |
| Multilevel (`2l.*`, JOMO) | FIMD2018 Ch. 7 | `pymice.methods.twol_*`, `jomo*` |
| Ampute (MCAR/MAR/MNAR) | mice `ampute` | `pymice.ampute` |
| Parallel chains | R `futuremice` | `pymice.parallel` |
| Cross-language RNG | REPRODUCIBILITY.md | `pymice.rng` |