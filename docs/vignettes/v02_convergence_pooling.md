...
**Reference:** https://www.gerkovink.com/miceVignettes/Convergence_pooling/Convergence_and_pooling.html
**Parity status:** Partially compliant — 16 match, 5 info, 5 partial, 0 skipped (R-only)
...
**Step parity:** ✅ MATCH (0 exact, 2 info, 0 visual, 0 skipped, 0 mismatch of 2 blocks)
...
**Note:** Step creates `imp` object; R vignette prints no console output here.
...
**Note:** R vignette shows code only; no console output to compare.
...
**Step parity:** ⚠️ PARTIAL (0 exact, 1 info, 1 visual, 0 skipped, 0 mismatch of 2 blocks)
...
**Note:** Seed argument demonstration; no console output in R vignette.
...
**Step parity:** ⚠️ PARTIAL (7 exact, 1 info, 1 visual, 0 skipped, 0 mismatch of 9 blocks)
...
**Note:** R vignette shows code only before trace plot.
...
**Step parity:** ✅ MATCH (4 exact, 0 info, 0 visual, 0 skipped, 0 mismatch of 4 blocks)
