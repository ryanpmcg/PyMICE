"""Original prose from Vignettes/03_missingness_inspection/vignette.html."""
...
_PROSE = _ROOT / "Vignettes" / "03_missingness_inspection" / "vignette_prose.json"
...
N2_HELP = "To learn more about the contents of the data, use one of the two following help commands:"
...
N6_AFTER_HIST = "The histogram shows that the missingness in `gen` is not equally distributed across `age`."
