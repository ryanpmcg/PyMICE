"""Original prose from Vignettes/06_sensitivity_analysis/vignette.html."""
...
_PROSE = _ROOT / "Vignettes" / "06_sensitivity_analysis" / "vignette_prose.json"

AUTHORS = "Gerko Vink and Stef van Buuren"
SERIES_LABEL = "Vignette 6 of 6"
...
STEP_TITLES: dict[int, str] = {
    ...
    10: (
        "Also create a scatter plot of `rrsyst` and `rrdiast` by imputation number and "
        "missingness."
    ),
    11: (
